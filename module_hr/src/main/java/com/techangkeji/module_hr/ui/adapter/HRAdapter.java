...
public class HRAdapter extends BaseQuickAdapter<BuildingListEntity.DataBean, BaseViewHolder> {
    public HRAdapter(int layoutResId, @Nullable List<BuildingListEntity.DataBean> data) {
