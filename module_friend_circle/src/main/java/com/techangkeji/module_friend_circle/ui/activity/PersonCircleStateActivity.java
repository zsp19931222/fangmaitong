...
import com.techangkeji.module_friend_circle.databinding.ActivityPersonCircleStateBinding;
...
@Route(path = ARouterPath.FriendCircle.PersonCircleStateActivity)
public class PersonCircleStateActivity extends BaseActivity<ActivityPersonCircleStateBinding, BaseViewModel> implements ImageWatcher.OnPictureLongPressListener, ImageWatcher.Loader {
    @Override
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_person_circle_state;
    }
