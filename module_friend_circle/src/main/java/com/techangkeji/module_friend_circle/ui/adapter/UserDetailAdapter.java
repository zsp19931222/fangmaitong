...
public class UserDetailAdapter extends BaseQuickAdapter<FriendCircleBean, BaseViewHolder> {
    private RequestOptions mRequestOptions;
    private DrawableTransitionOptions mDrawableTransitionOptions;
    private EmojiPanelView emojiPanelView;
    private UserDetailViewModel viewModel;

    public UserDetailAdapter(int layoutResId, @Nullable List<FriendCircleBean> data, EmojiPanelView emojiPanelView, UserDetailViewModel viewModel) {
