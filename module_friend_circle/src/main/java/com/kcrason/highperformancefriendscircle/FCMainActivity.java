...
@Route(path = ARouterPath.FriendCircle.FriendCircleActivity)
public class FCMainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,
...
//                startActivity(new Intent(FCMainActivity.this, EmojiPanelActivity.class)));
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    Glide.with(FCMainActivity.this).resumeRequests();
                } else {
                    Glide.with(FCMainActivity.this).pauseRequests();
                }
            }
