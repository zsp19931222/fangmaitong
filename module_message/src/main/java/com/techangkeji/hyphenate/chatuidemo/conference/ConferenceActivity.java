package com.techangkeji.hyphenate.chatuidemo.conference;
...
import com.techangkeji.hyphenate.chatuidemo.ui.BaseActivity;
import com.techangkeji.hyphenate.chatuidemo.utils.PhoneStateManager;
...
public class ConferenceActivity extends BaseActivity implements EMConferenceListener {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        CallFloatWindow.getInstance(BaseApplication.getInstance().getBaseContext()).dismiss();
        DeskShareWindow.getInstance(BaseApplication.getInstance().getBaseContext()).dismiss();
    }
