...
public class ArchitectTypePopupwindow extends BasePopupWindow {

    public ArchitectTypePopupwindow(Context context, String s) {
        super(context);
    ...
    public View onCreateContentView() {
        return createPopupById(R.layout.popup_architecture_type);
    }
