...
public class EducationStatePopupwindow extends BasePopupWindow {

    public EducationStatePopupwindow(Context context, String s) {
        super(context);
        ...
        TextView tv_pt7 = findViewById(R.id.tv_pt7);
        TextView tv_pt8 = findViewById(R.id.tv_pt8);
        ...
        View v_pt7 = findViewById(R.id.v_pt7);
        View v_pt8 = findViewById(R.id.v_pt8);
        ...
        if (s.equals(tv_pt7.getText().toString())){
            v_pt7.setVisibility(View.VISIBLE);
            tv_pt7.setTextColor(ContextCompat.getColor(context,R.color.color_FF8C00));
        }
        if (s.equals(tv_pt8.getText().toString())){
            v_pt8.setVisibility(View.VISIBLE);
            tv_pt8.setTextColor(ContextCompat.getColor(context,R.color.color_FF8C00));
        }
        ...
        tv_pt7.setOnClickListener(view -> {
            select(tv_pt7);
        });
        tv_pt8.setOnClickListener(view -> {
            select(tv_pt8);
        });
    }
    ...
    public View onCreateContentView() {
        return createPopupById(R.layout.popup_education_state);
    }
