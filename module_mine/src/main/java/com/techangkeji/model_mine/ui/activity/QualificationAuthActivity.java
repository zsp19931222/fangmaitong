...
import com.techangkeji.model_mine.ui.viewModel.QualificationAuthViewModel;
 ...
 * description: 资质证明
 * author: Andy
 * date: 2019/9/18 0018 15:16
 */
public class QualificationAuthActivity extends BaseActivity<ActivityQualificationAuthBinding, QualificationAuthViewModel> {
    @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case 10088:
                    for (int i = 0; i < PictureSelector.obtainMultipleResult(data).size(); i++) {
                        viewModel.uploadpic(PictureSelector.obtainMultipleResult(data).get(i).getCompressPath(), 10088);
                    }
                    break;
            }
        }
