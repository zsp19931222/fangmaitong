...
/**
 * description:
 * author:created by Andy on 2019/9/28 00:02
...
public class UserDetailEntity {
     ...
     * type : 0
     * unionid : null
     * location : {"remark":null,"location":"重庆市重庆市九龙坡区","createTime":"2019-09-27 11:18:04","latitude":"29.512274","id":464,"district":"九龙坡区","province":"重庆市","city":"重庆市","del":0,"userId":1,"areaId":10,"longitude":"106.467777","state":0}
     */
    ...
    public static class LocationBean {
         ...
         * remark : null
         * location : 重庆市重庆市九龙坡区
         * createTime : 2019-09-27 11:18:04
         * latitude : 29.512274
         * id : 464
         * district : 九龙坡区
         * province : 重庆市
    ...
    public String toString() {
        return "UserDetailEntity{" +
                ...
                ", password='" + password + '\'' +
                ", wechatLanguage=" + wechatLanguage +
                ", realName='" + realName + '\'' +
                ", oldPassword=" + oldPassword +
                ", wechatProvince=" + wechatProvince +
                ", jobhuntingNum=" + jobhuntingNum +
                ", realNameAuthenticate=" + realNameAuthenticate +
                ", wechatCountry=" + wechatCountry +
                ", sex=" + sex +
                ", imPassword='" + imPassword + '\'' +
                ", state=" + state +
                ", wxappCountry=" + wxappCountry +
                ", id=" + id +
                ", lastLogin='" + lastLogin + '\'' +
                ...
                ", age=" + age +
                ", buildNum=" + buildNum +
                ", cumulativeLoginTime=" + cumulativeLoginTime +
                ", wxappProvince=" + wxappProvince +
                ", enable=" + enable +
