...
public class CaocConfig implements Serializable {
    ...
    public static class Builder {
        ...
        /**
         * Defines if the error activity_invite_information must be launched when the app is on background.
         * BackgroundMode.BACKGROUND_MODE_SHOW_CUSTOM: launch the error activity_invite_information when the app is in background,
        ...
        /**
         * Defines if the error activity_invite_information must shown the error details button.
        ...
        /**
         * Defines if the error activity_invite_information should show a restart button.
         ...
         * a close button will still be used by the default error activity_invite_information.
         * The default is true.
         */
        @NonNull
         ...
         * the error activity_invite_information will not be launched and the system crash screen will be invoked.
         * The default is 3000.
         */
        @NonNull
        ...
        /**
         * Defines which drawable to use in the default error activity_invite_information image.
        ...
        /**
         * Sets the error activity_invite_information class to launch when a crash occurs.
         * If null, the default error activity_invite_information will be used.
         */
        @NonNull
        ...
        /**
         * Sets the main activity_invite_information class that the error activity_invite_information must launch when a crash occurs.
         * If not set or set to null, the default launch activity_invite_information will be used.
         * If your app has no launch activities and this is not set, the default error activity_invite_information will close instead.
         */
        @NonNull
