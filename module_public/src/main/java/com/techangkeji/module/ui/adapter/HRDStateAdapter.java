...
public class HRDStateAdapter extends BaseQuickAdapter<CommentListEntity.DataBean, BaseViewHolder> {
    public HRDStateAdapter(int layoutResId, @Nullable List<CommentListEntity.DataBean> data) {
