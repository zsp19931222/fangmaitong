...
public class CommentStateAdapter extends BaseQuickAdapter<ReviewListEntity.DataBean, BaseViewHolder> {
    public CommentStateAdapter(int layoutResId, @Nullable List<ReviewListEntity.DataBean> data) {
